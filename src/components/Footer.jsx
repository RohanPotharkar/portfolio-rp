...
export default function Footer() {
   ...
   return (
      <div className="isolate bg-white px-6 py-24 sm:py-10 lg:px-8 border-t-1 border-t-gray-600">
         <div
            aria-hidden="true"
         ...
         <div className="mx-auto max-w-2xl text-center">
            <p className="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-6xl">Contact Us</p>
            <p className="mt-2 text-lg/8 text-gray-600">Currently, this form is not working properly. Please kindly get in touch with us on our email by clicking send email button below.</p>
         </div>
         <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
            ...
            <div className="mt-10">
               <a
                  href='mailto:rohanpotharkaroffice@gmail.com'
